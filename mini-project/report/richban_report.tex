...
Also the accuracy greatly varied accross different distribution of training and testing. The chart below shows different accuracy obtained for different split of data (train&test) and k = 5.
...
Lastly, for the frequent pattern mining I have used Apriori Algorithm in order to found out which programming languages are most likely group togther within ITU students. \textit{What itemset of programming languages do itu students know?}. 

\subsection{Results}

The implementation consists of 2 parts, first I have found the all the frequent itemsets which meet the minimum support level \textit{min\_sup=0.2}.
